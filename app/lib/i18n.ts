...
const cs = {
  ...
  generate: {
    ...
    descriptions: {
      text: "Poznámka, zpráva, cokoliv",
      url: "Odkaz na web",
      wifi: "Přístup k síti",
      password: "Bezpečné uložení",
  ...
  library: {
    ...
    confirmDeleteEntry: "Opravdu smazat tento kód?",
    unknownContact: "Neznámý kontakt",
    categories: { password: "Hesla", url: "URL", text: "Text", wifi: "WiFi", vcard: "Vizitky" }
  },
  settings: {
    language: "Jazyk",
  ...
  fab: {
    scan: "SCAN",
    scanQr: "Skenovat QR",
    scanQrDesc: "Kamera — QR kódy",
    scanBarcode: "Skenovat Barcode",
    scanBarcodeDesc: "Kamera — čárové kódy",
    magicDecoder: "Magic Decoder",
    magicDecoderDesc: "AI — cokoliv z fotky"
  }
};
...
const en = {
  ...
  library: {
    ...
    confirmDeleteEntry: "Delete this code?",
    unknownContact: "Unknown Contact",
    categories: { password: "Passwords", url: "URL", text: "Text", wifi: "WiFi", vcard: "Contacts" }
  },
  settings: {
    language: "Language",
  ...
  fab: {
    scan: "SCAN",
    scanQr: "Scan QR",
    scanQrDesc: "Camera — QR codes",
    scanBarcode: "Scan Barcode",
    scanBarcodeDesc: "Camera — barcodes",
    magicDecoder: "Magic Decoder",
    magicDecoderDesc: "AI — anything from a photo"
  }
};
...
const sk = {
  ...
  header: { title: "QR Tool", subtitle: "Všetky vaše kódy na jednom mieste.", create: "Vytvoriť nový kód", edit: "Upraviť kód", scan: "Zamerať kameru", library: "Uložené kódy", settings: "Nastavenia aplikácie", shareApp: "Zdieľať app" },
  ...
  library: { emptyTitle: "Knižnica je prázdna", emptySubtitle: "Žiadne uložené kódy.", endOfList: "Koniec zoznamu", clickToEnlarge: "Kliknite na zväčšenie", downloadPng: "Stiahnuť PNG", confirmDelete: "Odstrániť toto?", confirmDeleteEntry: "Odstrániť tento kód?", unknownContact: "Neznámy kontakt", categories: { password: "Heslá", url: "URL", text: "Text", wifi: "WiFi", vcard: "Vizitky" } },
  ...
  fab: { scan: "SCAN", scanQr: "Skenovať QR", scanQrDesc: "Kamera — QR kódy", scanBarcode: "Skenovať Barcode", scanBarcodeDesc: "Kamera — čiarové kódy", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — čokoľvek z fotky" }
};
// --- DEUTSCH ---
const de = {
  ...
  header: { title: "QR Tool", subtitle: "Alle Ihre Codes an einem Ort.", create: "Neuen Code erstellen", edit: "Code bearbeiten", scan: "Kamera ausrichten", library: "Gespeicherte Codes", settings: "App-Einstellungen", shareApp: "App teilen" },
  ...
  library: { emptyTitle: "Bibliothek ist leer", emptySubtitle: "Keine gespeicherten Codes vorhanden.", endOfList: "Ende der Liste", clickToEnlarge: "Zum Vergrößern klicken", downloadPng: "PNG herunterladen", confirmDelete: "Dies löschen?", confirmDeleteEntry: "Diesen Code löschen?", unknownContact: "Unbekannter Kontakt", categories: { password: "Passwörter", url: "URL", text: "Text", wifi: "WiFi", vcard: "Kontakte" } },
  ...
  fab: { scan: "SCAN", scanQr: "QR scannen", scanQrDesc: "Kamera — QR-Codes", scanBarcode: "Barcode scannen", scanBarcodeDesc: "Kamera — Strichcodes", magicDecoder: "Magic Decoder", magicDecoderDesc: "KI — alles aus einem Foto" }
};
// --- POLSKI ---
const pl = {
  ...
  header: { title: "QR Tool", subtitle: "Wszystkie Twoje kody w jednym miejscu.", create: "Utwórz nowy kod", edit: "Edytuj kod", scan: "Wycentruj kamerę", library: "Zapisane kody", settings: "Preferencje aplikacji", shareApp: "Udostępnij app" },
  ...
  library: { emptyTitle: "Biblioteka jest pusta", emptySubtitle: "Brak zapisanych kodów.", endOfList: "Koniec listy", clickToEnlarge: "Kliknij aby powiększyć", downloadPng: "Pobierz PNG", confirmDelete: "Usunąć to?", confirmDeleteEntry: "Usunąć ten kod?", unknownContact: "Nieznany kontakt", categories: { password: "Hasła", url: "URL", text: "Tekst", wifi: "WiFi", vcard: "Kontakty" } },
  ...
  fab: { scan: "SCAN", scanQr: "Skanuj QR", scanQrDesc: "Kamera — kody QR", scanBarcode: "Skanuj kod kreskowy", scanBarcodeDesc: "Kamera — kody kreskowe", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — cokolwiek ze zdjęcia" }
};
// --- ROMÂNĂ ---
const ro = {
  ...
  header: { title: "QR Tool", subtitle: "Toate codurile tale într-un singur loc.", create: "Creează cod nou", edit: "Editează cod", scan: "Focalizează camera", library: "Coduri salvate", settings: "Preferințe aplicație", shareApp: "Partajează app" },
  ...
  library: { emptyTitle: "Bibliotecă goală", emptySubtitle: "Încă nu sunt coduri salvate.", endOfList: "Sfârșitul listei", clickToEnlarge: "Apasă pentru a mări", downloadPng: "Descarcă PNG", confirmDelete: "Ștergi aceasta?", confirmDeleteEntry: "Ștergi acest cod?", unknownContact: "Contact necunoscut", categories: { password: "Parole", url: "URL", text: "Text", wifi: "WiFi", vcard: "Contacte" } },
  ...
  fab: { scan: "SCAN", scanQr: "Scanează QR", scanQrDesc: "Cameră — coduri QR", scanBarcode: "Scanează cod de bare", scanBarcodeDesc: "Cameră — coduri de bare", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — orice dintr-o fotografie" }
};
// --- MAGYAR ---
const hu = {
  ...
  header: { title: "QR Tool", subtitle: "Az összes kódod egy helyen.", create: "Új kód létrehozása", edit: "Kód szerkesztése", scan: "Kamera fókuszálása", library: "Mentett kódok", settings: "Alkalmazás beállításai", shareApp: "App megosztása" },
  ...
  library: { emptyTitle: "Könyvtár üres", emptySubtitle: "Még nincsenek mentett kódok.", endOfList: "A lista vége", clickToEnlarge: "Kattints a nagyításhoz", downloadPng: "PNG letöltése", confirmDelete: "Törlöd ezt?", confirmDeleteEntry: "Törlöd ezt a kódot?", unknownContact: "Ismeretlen kontakt", categories: { password: "Jelszavak", url: "URL", text: "Szöveg", wifi: "WiFi", vcard: "Névjegyek" } },
  ...
  fab: { scan: "SCAN", scanQr: "QR beolvasása", scanQrDesc: "Kamera — QR-kódok", scanBarcode: "Vonalkód beolvasása", scanBarcodeDesc: "Kamera — vonalkódok", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — bármi egy fényképről" }
};
// --- ESPAÑOL ---
const es = {
  ...
  header: { title: "QR Tool", subtitle: "Todos tus códigos en un solo lugar.", create: "Crear nuevo código", edit: "Editar código", scan: "Enfocar cámara", library: "Códigos guardados", settings: "Preferencias de la app", shareApp: "Compartir app" },
  ...
  library: { emptyTitle: "Biblioteca vacía", emptySubtitle: "Sin códigos guardados aún.", endOfList: "Fin de la lista", clickToEnlarge: "Haz clic para ampliar", downloadPng: "Descargar PNG", confirmDelete: "¿Eliminar esto?", confirmDeleteEntry: "¿Eliminar este código?", unknownContact: "Contacto desconocido", categories: { password: "Contraseñas", url: "URL", text: "Texto", wifi: "WiFi", vcard: "Contactos" } },
  ...
  fab: { scan: "SCAN", scanQr: "Escanear QR", scanQrDesc: "Cámara — códigos QR", scanBarcode: "Escanear código de barras", scanBarcodeDesc: "Cámara — códigos de barras", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — cualquier cosa de una foto" }
};
// --- FRANÇAIS ---
const fr = {
  ...
  header: { title: "QR Tool", subtitle: "Tous vos codes en un seul endroit.", create: "Créer un nouveau code", edit: "Modifier le code", scan: "Activer la caméra", library: "Codes enregistrés", settings: "Préférences de l'application", shareApp: "Partager app" },
  ...
  library: { emptyTitle: "Bibliothèque vide", emptySubtitle: "Aucun code enregistré pour le moment.", endOfList: "Fin de la liste", clickToEnlarge: "Cliquer pour agrandir", downloadPng: "Télécharger PNG", confirmDelete: "Supprimer ceci ?", confirmDeleteEntry: "Supprimer ce code ?", unknownContact: "Contact inconnu", categories: { password: "Mots de passe", url: "URL", text: "Texte", wifi: "WiFi", vcard: "Contacts" } },
  ...
  fab: { scan: "SCAN", scanQr: "Scanner QR", scanQrDesc: "Caméra — codes QR", scanBarcode: "Scanner code-barres", scanBarcodeDesc: "Caméra — codes-barres", magicDecoder: "Magic Decoder", magicDecoderDesc: "IA — n'importe quoi d'une photo" }
};
// --- ITALIANO ---
const it = {
  ...
  header: { title: "QR Tool", subtitle: "Tutti i tuoi codici in un unico posto.", create: "Crea nuovo codice", edit: "Modifica codice", scan: "Attiva fotocamera", library: "Codici salvati", settings: "Preferenze app", shareApp: "Condividi app" },
  ...
  library: { emptyTitle: "Libreria vuota", emptySubtitle: "Nessun codice salvato ancora.", endOfList: "Fine dell'elenco", clickToEnlarge: "Clicca per ingrandire", downloadPng: "Scarica PNG", confirmDelete: "Eliminare questo?", confirmDeleteEntry: "Eliminare questo codice?", unknownContact: "Contatto sconosciuto", categories: { password: "Password", url: "URL", text: "Testo", wifi: "WiFi", vcard: "Contatti" } },
  ...
  fab: { scan: "SCAN", scanQr: "Scansiona QR", scanQrDesc: "Fotocamera — codici QR", scanBarcode: "Scansiona codice a barre", scanBarcodeDesc: "Fotocamera — codici a barre", magicDecoder: "Magic Decoder", magicDecoderDesc: "IA — qualsiasi cosa da una foto" }
};
// --- PORTUGUÊS ---
const pt = {
  ...
  header: { title: "QR Tool", subtitle: "Todos os seus códigos em um único lugar.", create: "Criar novo código", edit: "Editar código", scan: "Ativar câmera", library: "Códigos salvos", settings: "Preferências do app", shareApp: "Compartilhar app" },
  ...
  library: { emptyTitle: "Biblioteca vazia", emptySubtitle: "Nenhum código salvo ainda.", endOfList: "Fim da lista", clickToEnlarge: "Clique para ampliar", downloadPng: "Baixar PNG", confirmDelete: "Deletar isto?", confirmDeleteEntry: "Deletar este código?", unknownContact: "Contato desconhecido", categories: { password: "Senhas", url: "URL", text: "Texto", wifi: "WiFi", vcard: "Contatos" } },
  ...
  fab: { scan: "SCAN", scanQr: "Escanear QR", scanQrDesc: "Câmera — códigos QR", scanBarcode: "Escanear código de barras", scanBarcodeDesc: "Câmera — códigos de barras", magicDecoder: "Magic Decoder", magicDecoderDesc: "IA — qualquer coisa de uma foto" }
};
// --- РУССКИЙ ---
const ru = {
  ...
  header: { title: "QR Tool", subtitle: "Все ваши коды в одном месте.", create: "Создать новый код", edit: "Редактировать код", scan: "Сфокусировать камеру", library: "Сохраненные коды", settings: "Параметры приложения", shareApp: "Поделиться" },
  ...
  library: { emptyTitle: "Библиотека пуста", emptySubtitle: "Сохраненных кодов еще нет.", endOfList: "Конец списка", clickToEnlarge: "Нажмите для увеличения", downloadPng: "Загрузить PNG", confirmDelete: "Удалить это?", confirmDeleteEntry: "Удалить этот код?", unknownContact: "Неизвестный контакт", categories: { password: "Пароли", url: "URL", text: "Текст", wifi: "WiFi", vcard: "Контакты" } },
  ...
  fab: { scan: "SCAN", scanQr: "Сканировать QR", scanQrDesc: "Камера — QR-коды", scanBarcode: "Сканировать штрихкод", scanBarcodeDesc: "Камера — штрихкоды", magicDecoder: "Magic Decoder", magicDecoderDesc: "ИИ — что угодно с фото" }
};
// --- УКРАЇНСЬКА ---
const uk = {
  ...
  header: { title: "QR Tool", subtitle: "Усі ваші коди в одному місці.", create: "Створити новий код", edit: "Редагувати код", scan: "Сфокусувати камеру", library: "Збережені коди", settings: "Параметри додатку", shareApp: "Поділитися" },
  ...
  library: { emptyTitle: "Бібліотека пуста", emptySubtitle: "Збережених кодів ще немає.", endOfList: "Кінець списку", clickToEnlarge: "Натисніть для збільшення", downloadPng: "Завантажити PNG", confirmDelete: "Видалити це?", confirmDeleteEntry: "Видалити цей код?", unknownContact: "Невідомий контакт", categories: { password: "Паролі", url: "URL", text: "Текст", wifi: "WiFi", vcard: "Контакти" } },
  ...
  fab: { scan: "SCAN", scanQr: "Сканувати QR", scanQrDesc: "Камера — QR-коди", scanBarcode: "Сканувати штрихкод", scanBarcodeDesc: "Камера — штрихкоди", magicDecoder: "Magic Decoder", magicDecoderDesc: "ШІ — будь-що з фото" }
};
// --- TÜRKÇE ---
const tr = {
  ...
  header: { title: "QR Tool", subtitle: "Tüm kodlarınız tek bir yerde.", create: "Yeni kod oluştur", edit: "Kodu düzenle", scan: "Kamerayı odakla", library: "Kaydedilen kodlar", settings: "Uygulama tercihleri", shareApp: "Uygulamayı paylaş" },
  ...
  library: { emptyTitle: "Kütüphane boş", emptySubtitle: "Henüz kaydedilen kod yok.", endOfList: "Listenin sonu", clickToEnlarge: "Büyütmek için tıklayın", downloadPng: "PNG İndir", confirmDelete: "Bunu sil?", confirmDeleteEntry: "Bu kodu sil?", unknownContact: "Bilinmeyen Kişi", categories: { password: "Parolalar", url: "URL", text: "Metin", wifi: "WiFi", vcard: "Kişiler" } },
  ...
  fab: { scan: "SCAN", scanQr: "QR Tara", scanQrDesc: "Kamera — QR kodları", scanBarcode: "Barkod Tara", scanBarcodeDesc: "Kamera — barkodlar", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — fotoğraftan her şey" }
};
// --- TIẾNG VIỆT ---
const vi = {
  ...
  header: { title: "QR Tool", subtitle: "Tất cả mã của bạn ở một nơi.", create: "Tạo mã mới", edit: "Chỉnh sửa mã", scan: "Lấy nét camera", library: "Mã đã lưu", settings: "Tùy chọn ứng dụng", shareApp: "Chia sẻ app" },
  ...
  library: { emptyTitle: "Thư viện trống", emptySubtitle: "Chưa có mã nào được lưu.", endOfList: "Cuối danh sách", clickToEnlarge: "Nhấp để phóng to", downloadPng: "Tải xuống PNG", confirmDelete: "Xóa cái này?", confirmDeleteEntry: "Xóa mã này?", unknownContact: "Danh bạ không xác định", categories: { password: "Mật khẩu", url: "URL", text: "Văn bản", wifi: "WiFi", vcard: "Danh bạ" } },
  ...
  fab: { scan: "SCAN", scanQr: "Quét QR", scanQrDesc: "Máy ảnh — mã QR", scanBarcode: "Quét mã vạch", scanBarcodeDesc: "Máy ảnh — mã vạch", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — bất kỳ từ ảnh" }
};
// --- 中文 ---
const zh = {
  ...
  header: { title: "QR Tool", subtitle: "所有代码集中在一个地方。", create: "创建新代码", edit: "编辑代码", scan: "对焦相机", library: "已保存的代码", settings: "应用偏好设置", shareApp: "分享应用" },
  ...
  library: { emptyTitle: "库为空", emptySubtitle: "还没有保存的代码。", endOfList: "列表末尾", clickToEnlarge: "点击放大", downloadPng: "下载PNG", confirmDelete: "删除此项?", confirmDeleteEntry: "删除此代码？", unknownContact: "未知联系人", categories: { password: "密码", url: "URL", text: "文本", wifi: "WiFi", vcard: "联系人" } },
  ...
  fab: { scan: "SCAN", scanQr: "扫描QR", scanQrDesc: "摄像头 — 二维码", scanBarcode: "扫描条码", scanBarcodeDesc: "摄像头 — 条形码", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — 照片识别" }
};
// --- 日本語 ---
const ja = {
  ...
  header: { title: "QR Tool", subtitle: "すべてのコードを一箇所に。", create: "新しいコードを作成", edit: "コードを編集", scan: "カメラにフォーカス", library: "保存済みコード", settings: "アプリの設定", shareApp: "アプリを共有" },
  ...
  library: { emptyTitle: "ライブラリが空です", emptySubtitle: "まだ保存されたコードはありません。", endOfList: "リストの終了", clickToEnlarge: "クリックして拡大", downloadPng: "PNGをダウンロード", confirmDelete: "これを削除しますか?", confirmDeleteEntry: "このコードを削除しますか？", unknownContact: "不明な連絡先", categories: { password: "パスワード", url: "URL", text: "テキスト", wifi: "WiFi", vcard: "連絡先" } },
  ...
  fab: { scan: "SCAN", scanQr: "QRスキャン", scanQrDesc: "カメラ — QRコード", scanBarcode: "バーコードスキャン", scanBarcodeDesc: "カメラ — バーコード", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — 写真から何でも" }
};
// --- 한국어 ---
const ko = {
  ...
  header: { title: "QR Tool", subtitle: "모든 코드를 한 곳에.", create: "새 코드 만들기", edit: "코드 편집", scan: "카메라 초점 맞추기", library: "저장된 코드", settings: "앱 설정", shareApp: "앱 공유" },
  ...
  library: { emptyTitle: "라이브러리가 비어있습니다", emptySubtitle: "저장된 코드가 아직 없습니다.", endOfList: "목록의 끝", clickToEnlarge: "클릭하여 확대", downloadPng: "PNG 다운로드", confirmDelete: "삭제하시겠습니까?", confirmDeleteEntry: "이 코드를 삭제하시겠습니까?", unknownContact: "알 수 없는 연락처", categories: { password: "비밀번호", url: "URL", text: "텍스트", wifi: "WiFi", vcard: "연락처" } },
  ...
  fab: { scan: "SCAN", scanQr: "QR 스캔", scanQrDesc: "카메라 — QR 코드", scanBarcode: "바코드 스캔", scanBarcodeDesc: "카메라 — 바코드", magicDecoder: "Magic Decoder", magicDecoderDesc: "AI — 사진에서 무엇이든" }
};
// --- العربية ---
const ar = {
  ...
  header: { title: "QR Tool", subtitle: "جميع أكوادك في مكان واحد.", create: "إنشاء رمز جديد", edit: "تحرير الرمز", scan: "تركيز الكاميرا", library: "الرموز المحفوظة", settings: "تفضيلات التطبيق", shareApp: "مشاركة التطبيق" },
  ...
  library: { emptyTitle: "المكتبة فارغة", emptySubtitle: "لا توجد رموز محفوظة بعد.", endOfList: "نهاية القائمة", clickToEnlarge: "انقر للتكبير", downloadPng: "تنزيل PNG", confirmDelete: "هل تريد الحذف؟", confirmDeleteEntry: "هل تريد حذف هذا الرمز؟", unknownContact: "جهة اتصال غير معروفة", categories: { password: "كلمات المرور", url: "URL", text: "نص", wifi: "WiFi", vcard: "جهات الاتصال" } },
  ...
  fab: { scan: "SCAN", scanQr: "مسح QR", scanQrDesc: "الكاميرا — رموز QR", scanBarcode: "مسح الباركود", scanBarcodeDesc: "الكاميرا — الباركود", magicDecoder: "Magic Decoder", magicDecoderDesc: "ذكاء اصطناعي — أي شيء من صورة" }
};
